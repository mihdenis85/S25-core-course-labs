...
```bash
$ minikube start
😄  minikube v1.35.0 on Arch rolling
...
kind: Secret
metadata:
  creationTimestamp: "2025-03-04T20:35:53Z"
  name: db-user-pass
  namespace: default
...
disks) during the prime generation; this gives the random number
generator a better chance to gain enough entropy.
gpg: revocation certificate stored as '/home/mihdenis85/.gnupg/openpgp-revocs.d/8B878F3F418054543516BD01CEB7B3A46DF89265.rev'
public and secret key created and signed.

pub   ed25519 2025-03-04 [SC] [expires: 2028-03-04]
      8B878F3F418054543516BD01CEB7B3A46DF89265
uid                      user <mail@example.org>
sub   cv25519 2025-03-04 [E] [expires: 2028-03-04]
...
NAME: app-python
LAST DEPLOYED: Tue Mar  4 20:42:36 2025
NAMESPACE: default
STATUS: deployed
REVISION: 1
NOTES:
...
NAME: vault
LAST DEPLOYED: Tue Mar  4 20:53:46 2025
NAMESPACE: default
STATUS: deployed
REVISION: 1
NOTES:
...
Key                Value
---                -----
created_time       2025-03-04T17:48:37.431043113Z
custom_metadata    <nil>
deletion_time      n/a
destroyed          false
version            1
...
I updated `podAnnotations`, also included proper [rendering][render-link]
and then decided to reinstall helms:
...
$ helm secrets install app-python app-python/ -n default -f secrets.yaml
NAME: app-python
LAST DEPLOYED: Tue Mar 04 21:40:27 2025
NAMESPACE: default
STATUS: deployed
REVISION: 1
NOTES:
